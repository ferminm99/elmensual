...
class ArticuloController extends Controller
{
    ...
    public function store(Request $request) {
        ...
        $request->validate([
            ...
            'precio_transferencia' => 'nullable|numeric|min:0',
        ...
        $articulo = Articulo::create([
            ...
            'precio_efectivo' => $request->input('precio_efectivo', $precios['precio_efectivo']),
            'precio_transferencia' => $request->input('precio_transferencia', $precios['precio_transferencia']),
